...
const flattenTeam = (team) => {
    ...
    return {
        ...
        highestTotalCargo: Math.max(...data.totalLowScored((low, i) => low + data.totalHighScored[i])),
        avgTotalCargo: getAvg(data.totalLowScored((low, i) => low + data.totalHighScored[i])),
        ...
        highestAutoTotalCargo: Math.max(...data.autoCargoLow((low, i) => low + data.autoCargoHigh[i])),
        avgAutoTotalCargo: getAvg(data.autoCargoLow((low, i) => low + data.autoCargoHigh[i])),
